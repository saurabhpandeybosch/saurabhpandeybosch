...
import com.ceea.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "ceeacommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "ceeacommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "ceeacommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "ceeacommercewebservices.v2.description";
	private static final String TITLE = "ceeacommercewebservices.v2.title";
	private static final String VERSION = "ceeacommercewebservices.v2.version";
	private static final String LICENSE = "ceeacommercewebservices.v2.license";
	private static final String LICENSE_URL = "ceeacommercewebservices.v2.license.url";
