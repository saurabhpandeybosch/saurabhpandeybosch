...
/**
 * Global class for all CeeaCore constants. You can add global constants for your extension into this class.
 */
public final class CeeaCoreConstants extends GeneratedCeeaCoreConstants
{
	public static final String EXTENSIONNAME = "ceeacore";


	private CeeaCoreConstants()
	{
		//empty
	}
