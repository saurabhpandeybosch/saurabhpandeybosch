 ...
 *
 */
public class PrimaryImageValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
	private static final Logger LOG = Logger.getLogger(PrimaryImageValueProvider.class);
			...
			final Object model) throws FieldValueProviderException
	{
		if (model instanceof ProductModel)
		{
			...
			final MediaModel media = product.getPicture();
			if (media != null)
			{
