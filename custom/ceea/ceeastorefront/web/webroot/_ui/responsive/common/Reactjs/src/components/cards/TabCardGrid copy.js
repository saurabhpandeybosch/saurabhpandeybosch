...
export default ({
  ...
  render()
  {
    const {isLoading, error, data} = useFetch("https://ceeawebapi.azure-api.net/myapi/products");
    ...
    const ProductData = ({ productPreview, ProductName, categoryName, productCompany, productDescription}) => (
      <div>
