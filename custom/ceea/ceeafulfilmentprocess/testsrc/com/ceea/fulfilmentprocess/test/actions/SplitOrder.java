 ...
 */
package com.ceea.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CeeaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CeeaFulfilmentProcessConstants.PARENT_PROCESS);
